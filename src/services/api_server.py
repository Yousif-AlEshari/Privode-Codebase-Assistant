...
# # ────────────────────────────────
# load_dotenv()
# app = FastAPI(title="Private Codebase Assistant")
...
# @app.post("/ask")
# def ask_code_assistant(query: Query):
#     try:
#         # 1️⃣ Embed question & retrieve top-k
#         response = nomic_text(texts=[query.question])
...
#         # 2️⃣ Build prompt
#         prompt = f"""
#         You are an AI assistant helping developers understand a private codebase.
# Use only the provided code context to answer. Cite file names/functions.
